                            ...
                            if (!artPath.isNullOrEmpty()) {
                                try {
                                    ...
                                    if (artFile.exists()) {
                                        ...
                                        if (bitmap != null) {
                                            metaBuilder.putBitmap(android.media.MediaMetadata.METADATA_KEY_ART, bitmap)
                                            metaBuilder.putBitmap(android.media.MediaMetadata.METADATA_KEY_ALBUM_ART, bitmap)
                                        }
                                    }
                                } catch (_: Exception) {}
                            }
